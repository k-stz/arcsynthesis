...
(defun draw-forest (matrix-stack)
  (loop for forest-data in *tree-data*
     for fx-pos = (first forest-data)
     for fz-pos = (second forest-data)
     for trunk-height = (third forest-data)
     for cone-height = (fourth forest-data)
     do
       (glutil:with-transform (matrix-stack)
